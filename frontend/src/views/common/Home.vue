...
const roleActions = {
  admin: [
    ...
    { name: '试卷管理', path: '/dashboard/admin/paper-management', icon: 'Files', color: '#409EFF' },
    { name: '考试管理', path: '/dashboard/admin/exam-management', icon: 'Calendar', color: '#409EFF' },
    { name: '成绩管理', path: '/dashboard/admin/score-management', icon: 'TrendCharts', color: '#E6A23C' },
    { name: '题目审核', path: '/dashboard/admin/question-audit', icon: 'Check', color: '#F56C6C' },
    { name: '题库管理', path: '/dashboard/admin/question-bank', icon: 'Collection', color: '#67C23A' }
  ],
  teacher: [
